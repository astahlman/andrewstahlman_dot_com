...
#+PROPERTY: header-args:bash :session spotify :cache no

* What's going on on this machine?
...
#+BEGIN_SRC bash :session none :results output
w
#+END_SRC
...
#+BEGIN_SRC bash
ps -ef | grep -i "Spotify.app"
#+END_SRC

#+RESULTS:
| 501 |   684 |     1 | 0 | 1:30PM | ?? | 1:22.77 | /Applications/Spotify.app/Contents/MacOS/Spotify      | -psn_0_73746                      |             |                                                  |                                         |                                                                 |                        |                                                                 |                                                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |                                                                 |                                          |                                      |                              |                                                                  |                                       |                                                                  |                        |
| 501 |   801 |     1 | 0 | 1:30PM | ?? | 0:00.13 | /Applications/Spotify.app/Contents/Frameworks/Spotify | Helper.app/Contents/MacOS/Spotify | Helper      | --monitor-self-annotation=ptype=crashpad-handler | --type=crashpad-handler                 | --max-uploads=5                                                 | --max-db-size=20       | --max-db-age=5                                                  | --database=/Users/andrewstahlman/Library/Application | Support/Spotify/User                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Data                                                            | --url=https://crashdump.spotify.com:443/ | --annotation=platform=macos          | --annotation=product=spotify | --annotation=version=1.0.87.491                                  | --handshake-fd=8                      |                                                                  |                        |
| 501 |   831 |   684 | 0 | 1:30PM | ?? | 0:44.95 | /Applications/Spotify.app/Contents/Frameworks/Spotify | Helper.app/Contents/MacOS/Spotify | Helper      | --type=gpu-process                               | --disable-features=ExtendedMouseButtons | --log-file=/Users/andrewstahlman/Library/Logs/Spotify_debug.log | --log-severity=disable | --product-version=Spotify/1.0.87.491                            | --lang=en                                            | --gpu-preferences= | --log-file=/Users/andrewstahlman/Library/Logs/Spotify_debug.log | --log-severity=disable                   | --product-version=Spotify/1.0.87.491 | --lang=en                    | --service-request-channel-token=34180C07F3E9304908F8ADF63A87DF04 |                                       |                                                                  |                        |
| 501 |   846 |   684 | 0 | 1:30PM | ?? | 1:59.20 | /Applications/Spotify.app/Contents/Frameworks/Spotify | Helper.app/Contents/MacOS/Spotify | Helper      | --type=renderer                                  | --disable-features=ExtendedMouseButtons | --service-pipe-token=16A831909EA47E75A8DB618C48ED4BEF           | --lang=en              | --log-file=/Users/andrewstahlman/Library/Logs/Spotify_debug.log | --log-severity=disable                               | --product-version=Spotify/1.0.87.491                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | --disable-scroll-bounce                                         | --disable-spell-checking                 | --num-raster-threads=4               | --enable-zero-copy           | --enable-gpu-memory-buffer-compositor-resources                  | --enable-main-frame-before-activation | --service-request-channel-token=16A831909EA47E75A8DB618C48ED4BEF | --renderer-client-id=3 |
| 501 | 15177 | 15175 | 0 | 4:52PM | ?? | 0:00.00 | grep                                                  | -i                                | Spotify.app |                                                  |                                         |                                                                 |                        |                                                                 |                                                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |                                                                 |                                          |                                      |                              |                                                                  |                                       |                                                                  |                        |
...
cat "/Users/andrewstahlman/Library/Caches/com.spotify.client/Browser/Local Storage/leveldb/000544.log" | LC_ALL=C sed 's/\\n/\
...
Now launch firefox and give it a few seconds to initialize. Then check
the syscalls.
...
half of this stuff. Disclaimer over, let's get to it.
...
Yep, same IP, two different hostnames.
...
<figure>
    ...
    <figcaption>Image credit to <a href="https://unix.stackexchange.com/users/31673/erik">erik</a> (https://unix.stackexchange.com/a/118650)</figcaption>
</figure>
#+END_EXPORT
